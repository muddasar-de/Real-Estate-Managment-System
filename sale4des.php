...
<br>
   ...
   <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <img class="d-block w-100" src="pictures\interior4-1.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior4-2.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior4-3.jpg" alt="Third slide">
        </div>
         <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior8-1.jpg" alt="Third slide">
        </div>
         <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior9-1.jpg" alt="Third slide">
        </div>
      </div>
      <!--/.Slides-->
      <!--Controls-->
      ...
      <ol class="carousel-indicators">
        <li data-target="#carousel-thumb" data-slide-to="0" class="active" style="width: 25%;height: auto;"> <img class="d-block w-100"  src="pictures\interior4-1.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="1" style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior4-2.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="2"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior4-3.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="3"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior8-1.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="4"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior9-1.jpg"
            class="img-fluid"></li>
      </ol>
    </div>
    ...
    <tbody>
      <tr>
        <td>4</td>
        <td>Gulshan Abad, Lala Zar, Rawalpindi</td>
        <td>  
          <dl>
