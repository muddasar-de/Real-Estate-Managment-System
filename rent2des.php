  ...
  <nav class="navbar navbar-expand-sm bg-light navbar-light  ">
    ...
    <div class="collapse navbar-collapse navitems-mobile" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="sales.htm">Sales</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="rentals.htm">Rentals</a>
        </li> 
        <li class="nav-item">
          <a class="nav-link " href="agents.htm">Agents</a>
        </li> 
...
<br>
   ...
   <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <img class="d-block w-100" src="pictures\interior2-1.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior2-2.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior2-3.jpg" alt="Third slide">
        </div>
         <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior6-1.jpg" alt="Third slide">
        </div>
         <div class="carousel-item">
          <img class="d-block w-100" src="pictures\interior7-1.jpg" alt="Third slide">
        </div>
      </div>
      <!--/.Slides-->
      <!--Controls-->
      ...
      <ol class="carousel-indicators">
        <li data-target="#carousel-thumb" data-slide-to="0" class="active" style="width: 25%;height: auto;"> <img class="d-block w-100"  src="pictures\interior2-1.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="1" style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior2-2.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="2"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior2-3.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="3"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior6-1.jpg"
            class="img-fluid"></li>
        <li data-target="#carousel-thumb" data-slide-to="4"  style="width: 25%;height: auto"><img class="d-block w-100" src="pictures\interior7-1.jpg"
            class="img-fluid"></li>
      </ol>
    </div>
    ...
    <tbody>
      <tr>
        <td>9</td>
        <td>Al-Syed Avenue, Near Comsats University, Islambad</td>
        <td>  
          <dl>
        ...
        <td>$1,500/month</td>
         <td><a href="contact.htm" class="btn btn-dark ">Contact Us</a></td>
      </tr>
    </tbody>
  </table>
</div>
