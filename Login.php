<?php
    if (isset($_POST['SubmitLogin'])) {
        ...
        $stmt = $conn->prepare("SELECT userId, UName, UEmail, UPassword FROM user WHERE UEmail=? AND UPassword=? LIMIT 1");
            ...
            <div class="modal-content " style="background: linear-gradient(to bottom, #0099ff 0%, #66ffff 100%);padding: 15% 25%;">
                ...
                <div class="modal-body">
                    <form method="POST" autocomplete="off">
                        ...
                        <br>
                        <input type="Submit" class="btn btn-light mx-auto d-block px-3" value="Login" name="SubmitLogin" />
                    </form>
                </div>
            </div>
        </div>
